        ...
        <div className="container mx-auto h-full flex flex-col items-center xl:flex-row xl:items-start gap-x-6 mt-10">
          <div className="flex flex-1 flex-col justify-center z-10 mb-5 xl:mb-0">
            ...
            >
              ...
              JavaScript, with expertise in using various frameworks such as
              React and Next. Experienced in optimizing websites to ensure
              optimal user experience. Excellent problem-solving abilities and
              the ability to work seamlessly in a team environment. Committed to
